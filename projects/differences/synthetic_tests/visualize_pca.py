...
def plot_pca(X_pca, labels, explained_variance, save_path='prep/pca_plot.png'):
    ...
    plt.scatter(X_pca[labels == 0, 0], X_pca[labels == 0, 1], color='#3182bd', label='Pre-activation', alpha=0.8, edgecolors='k', s=80)
    plt.scatter(X_pca[labels == 1, 0], X_pca[labels == 1, 1], color='#e6550d', label='Activation', alpha=0.8, edgecolors='k', s=80)
