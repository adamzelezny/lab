...
def create_custom_gene_sets():
    gene_sets = {'neural_activation': ['Fos', 'Jun', 'Egr1', 'Arc', 'Bdnf', 'Vegfa', 'Hif1a', 'Cxcl10', 'Il6'], 'cell_cycle_proliferation': ['Mki67', 'Top2a', 'Pcna'], 'glial_myelin_lineage': ['Mog', 'Mbp', 'Plp1'], 'astrocyte_markers': ['Gfap', 'Aqp4'], 'immune_microglia': ['Cd68', 'Aif1', 'Ccl2', 'Cxcl10', 'Tnf'], 'endothelial_vascular': ['Pecam1', 'Kdr', 'Vegfa']}
    return gene_sets
...
def run_gsea_prerank(ranked_genes, gene_sets):
    pre_res = gp.prerank(rnk=ranked_genes, gene_sets=gene_sets, threads=1, min_size=1, max_size=100, permutation_num=1000, outdir=None, seed=42)
