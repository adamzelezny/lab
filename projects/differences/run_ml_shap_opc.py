...
# ============================================================
# FILTER TO OPC-LIKE CELLS (CLUSTER 12)
# ============================================================
...
# Since the test set is small (~200 cells), we can explain the entire test set
...
# Calculate mean log-normalized expression in control vs activity OPCs to find direction of regulation
