...
# ============================================================
# BASIC PCA SCATTER PLOTS
# ============================================================

print("\nCreating PCA plots...")

plots = [
    ("condition", "pca_condition.png"),
    ("timepoint", "pca_timepoint.png"),
    ("total_counts", "pca_total_counts.png"),
    ("n_genes_by_counts", "pca_genes_detected.png"),
    ("pct_counts_mt", "pca_mito_percent.png"),
    ("pct_counts_ribo", "pca_ribo_percent.png"),
]
...
# ============================================================
# ADDITIONAL PC COMBINATIONS
# ============================================================

pc_pairs = [
    ("1,2", "pca_pc1_pc2_condition.png"),
    ("2,3", "pca_pc2_pc3_condition.png"),
    ("3,4", "pca_pc3_pc4_condition.png"),
    ("4,5", "pca_pc4_pc5_condition.png"),
]
