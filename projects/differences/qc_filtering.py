...
keep_cells = (adata.obs['n_genes_by_counts'] >= MIN_GENES) & (adata.obs['n_genes_by_counts'] <= MAX_GENES) & (adata.obs['pct_counts_mt'] <= MAX_MT_PERCENT) & (adata.obs['total_counts'] >= MIN_COUNTS)
