...
plot_items = [
    ...
    ("timepoint", "umap_timepoint.png"),
    ("total_counts", "umap_total_counts.png"),
    ("n_genes_by_counts", "umap_genes_detected.png"),
    ("pct_counts_mt", "umap_mito_percent.png"),
    ("pct_counts_ribo", "umap_ribo_percent.png"),
]
