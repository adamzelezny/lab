...
def parse_gsea_csv(csv_path: str) -> list[tuple[str, float]]:
    ...
    # clean GO ID out of pathway term name to make it look clean like "Aerobic Respiration"
    # Example: "Aerobic Respiration (GO:0009060)" -> "Aerobic Respiration"
    cleaned_terms = []
    for term in df['Term']:
        if " (GO:" in term:
    ...
    # Sort by absolute NES descending and take top 20
...
def main():
    ...
    # 6 file mappings (Pop, Sub-section, Folder Name)
    comparisons = [
        ("Malignant", "R88Q vs H1047R", "tumor_H1047R_vs_R88Q_control"),
        ("Malignant", "R88Q vs C420R", "tumor_C420R_vs_R88Q_control"),
        ("Malignant", "H1047R vs C420R", "tumor_H1047R_vs_C420R_direct"),
        ("Neurons", "R88Q vs H1047R", "neuron_H1047R_vs_R88Q_control"),
        ("Neurons", "R88Q vs C420R", "neuron_C420R_vs_R88Q_control"),
        ("Neurons", "H1047R vs C420R", "neuron_H1047R_vs_C420R_direct")
    ]
