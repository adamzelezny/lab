...
def run_driver_evaluation():
    ...
    comparisons = [('tumor', 'H1047R', 'R88Q', 'tumor_H1047R_vs_R88Q_control', tumor_mask), ('tumor', 'C420R', 'R88Q', 'tumor_C420R_vs_R88Q_control', tumor_mask), ('tumor', 'H1047R', 'C420R', 'tumor_H1047R_vs_C420R_direct', tumor_mask), ('neuron', 'H1047R', 'R88Q', 'neuron_H1047R_vs_R88Q_control', neuron_mask), ('neuron', 'C420R', 'R88Q', 'neuron_C420R_vs_R88Q_control', neuron_mask), ('neuron', 'H1047R', 'C420R', 'neuron_H1047R_vs_C420R_direct', neuron_mask)]
