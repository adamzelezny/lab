...
def plot_dot_plot(summary_data, output_path):
    ...
    ax.set_title('Metabolic Marker Profile (Dot Plot)', fontsize=14, pad=15)
...
def run_metabolic_analysis():
    ...
    summary_csv_path = 'c:/Users/adamz/Documents/lab/projects/anls/outputs/metabolic_summary.csv'
    plot_png_path = 'c:/Users/adamz/Documents/lab/projects/anls/outputs/metabolic_expression_comparison.png'
    dot_png_path = 'c:/Users/adamz/Documents/lab/projects/anls/outputs/metabolic_dot_plot.png'
    target_genes = ['Slc1a2', 'Slc1a3', 'Hk2', 'Pfkp', 'Ldha', 'Ldhb', 'Slc16a1', 'Slc16a3', 'Slc16a7', 'Slc2a1', 'Slc2a3', 'G6pdx', 'Pdha1', 'Pdk1', 'Glul', 'Gls']
