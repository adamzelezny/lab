...
def plot_dot_plot(summary_data, output_path):
    ...
    ax.set_title('Glycolysis Genes Profile (Dot Plot)', fontsize=14, pad=15)
    ax.grid(True, linestyle='--', alpha=0.3)
    plt.tight_layout()
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    plt.close()

def run_glycolysis_analysis():
    ...
    summary_csv_path = 'c:/Users/adamz/Documents/lab/projects/anls/outputs/glycolysis_summary.csv'
    plot_png_path = 'c:/Users/adamz/Documents/lab/projects/anls/outputs/glycolysis_expression_comparison.png'
    dot_png_path = 'c:/Users/adamz/Documents/lab/projects/anls/outputs/glycolysis_dot_plot.png'
    target_genes = ['Hk1', 'Hk2', 'Hk3', 'Gck', 'Gpi1', 'Pfkm', 'Pfkl', 'Pfkp', 'Aldoa', 'Aldob', 'Aldoc', 'Tpi1', 'Gapdh', 'Pgk1', 'Pgk2', 'Pgam1', 'Pgam2', 'Eno1', 'Eno2', 'Eno3', 'Pkm', 'Pklr']
